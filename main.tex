...
\newcommand{\madars}[1]{\colornote{blue}{#1}{Madars}}
\newcommand{\karthik}[1]{\colornote{brown}{#1}{Karthik}}
\newcommand{\joi}[1]{\colornote{cyan}{#1}{Joi}}
\newcommand{\sassan}[1]{\colornote{olive}{#1}{sassan}}
\newcommand{\chia}[1]{\colornote{purple}{#1}{Chia}}
\newcommand{\andre}[1]{\colornote{pink}{#1}{Andre}}
\newcommand{\natalie}[1]{\colornote{green}{#1}{Natalie}}
\newcommand{\jz}[1]{\colornote{grey}{#1}{JZ}}
\newcommand{\stephanie}[1]{\colornote{red}{#1}{Stephanie}}
\newcommand{\deb}[1]{\colornote{blue}{#1}{Deb Roy}}
\newcommand{\rdv}[1]{\colornote{red}{#1}{Rod Van Meter}}
\newcommand{\jun}[1]{\colornote{blue}{#1}{Jun Murai}}
\newcommand{\hiroya}[1]{\colornote{purple}{#1}{Hiroya Tanaka}}
\newcommand{\keiko}[1]{\colornote{pink}{#1}{Keiko Okawa}}

% Don't show comments 
\renewcommand{\dw}[1]{}
\renewcommand{\madars}[1]{}
\renewcommand{\karthik}[1]{}
\renewcommand{\joi}[1]{}
\renewcommand{\sassan}[1]{}
\renewcommand{\chia}[1]{}
\renewcommand{\andre}[1]{}
\renewcommand{\natalie}[1]{}
\renewcommand{\jz}[1]{}
\renewcommand{\stephanie}[1]{}
\renewcommand{\deb}[1]{}
\renewcommand{\rdv}[1]{}
\renewcommand{\jun}[1]{}
\renewcommand{\hiroya}[1]{}
\renewcommand{\keiko}[1]{}
